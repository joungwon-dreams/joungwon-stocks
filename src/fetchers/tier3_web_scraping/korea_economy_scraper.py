...
class KoreaEconomyScraper(BaseScraper):
    """한국경제 news scraper."""

    COMPANY_URL_TEMPLATE = "https://www.hankyung.com/finance/stock/{ticker}"
    SELECTORS = {
        'company_name': 'h1.company',
        'news_title': 'div.news-list article h3',
        'news_date': 'span.date',
    }
    ...
    async def parse_data(self, soup: BeautifulSoup, ticker: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for title in titles[:5]:  # Top 5 news
