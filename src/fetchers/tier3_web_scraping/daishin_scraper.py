...
class DaishinScraper(BaseScraper):
    """Daishin Securities scraper."""

    COMPANY_URL_TEMPLATE = "https://finance.naver.com/research/company_list.naver?searchType=itemCode&itemCode={ticker}&companyName=대신증권"
