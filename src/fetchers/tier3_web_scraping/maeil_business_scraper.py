...
class MaeilBusinessScraper(BaseScraper):
    """매일경제 news scraper."""

    COMPANY_URL_TEMPLATE = "https://stock.mk.co.kr/item/main.php?code={ticker}"
    SELECTORS = {
        'company_name': 'h2.company-name',
        'news_title': 'div.news_list li h3',
        'news_date': 'span.date',
