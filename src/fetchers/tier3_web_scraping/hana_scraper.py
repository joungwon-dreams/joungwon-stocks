...
class HanaScraper(BaseScraper):
    """Hana Securities scraper."""

    COMPANY_URL_TEMPLATE = "https://finance.naver.com/research/company_list.naver?searchType=itemCode&itemCode={ticker}&companyName=하나증권"
