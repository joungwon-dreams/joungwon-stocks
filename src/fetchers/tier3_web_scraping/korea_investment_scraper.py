"""
Korea Investment Reports Scraper
한국투자증권 리포트 웹 스크래퍼
"""
import logging
...
class KoreaInvestmentScraper(BaseScraper):
    """Korea Investment Securities Reports scraper."""

    COMPANY_URL_TEMPLATE = "https://finance.naver.com/research/company_list.naver?searchType=itemCode&itemCode={ticker}&companyName=한국투자증권"
